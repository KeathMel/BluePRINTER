from PyQt6.QtWidgets import QWidget, QVBoxLayout, QLabel, QLineEdit, QTextEdit, QPushButton, QSlider, QMessageBox
...
class MarkerPanel(QWidget):
    ...
    def init_ui(self):
        ...
        title_label.setStyleSheet(
            f"color: {theme.BLUE}; font-family: {theme.MONO}; "
            "font-weight: bold; font-size: 13pt; letter-spacing: 2px;")
        ...
        delete_btn.setStyleSheet(
            f"QPushButton {{ background-color: transparent; color: {theme.MARKER};"
            f" border: 1px solid {theme.MARKER}; padding: 8px; border-radius: 0px; }}"
            f"QPushButton:hover {{ background-color: {theme.MARKER}; color: {theme.INK};"
            f" border: 1px solid {theme.MARKER}; }}")
